...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API aplikasi mobile DOKEMAS (Dolan Keliling Banyumas). '
            .'Login via POST /login untuk dapat token, lalu klik tombol Authorize / isi Bearer token untuk endpoint privat.',
    ],
